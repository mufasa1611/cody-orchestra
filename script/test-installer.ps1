...
Assert-NotContains "script/install.ps1" '25334282c686d23b94d7fc8c0a0068e2509509ae' "Streamed Windows installer does not pin a stale bootstrap commit"
...
Assert-Contains "packages/codyx/src/cli/upgrade.ts" 'npm install -g codyx-ai@latest --no-audit --no-fund --force' "Interactive npm updates use the published package"
